...
def calculate_dist(shape_lines, shape_points, env_points):
...
if __name__ == "__main__":
    ...
    Fshape_points = shape_to_points(Fshape_norm, Fshape_scale)


    Fshape_points =  Fshape_points
    Fshape_triangulated = [
    ...
    Fshape_triangulated = Fshape_scale *Fshape_triangulated
    ...
    end_time = time.time()
    visual_training(start,Fshape_points, env_points=env_points, cnt=500,speed=speed,vmin=0)
