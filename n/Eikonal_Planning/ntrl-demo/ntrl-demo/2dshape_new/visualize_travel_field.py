...
def main():
    ...
    parser.add_argument('--x0',        type=float, default=0,  help='Origin x')
    parser.add_argument('--y0',        type=float, default=-0.03,  help='Origin y')
    parser.add_argument('--theta0',    type=float, default=np.pi/2,  help='Origin theta (rad)')
    ...
    Fshape_pts = shape_to_points(Fshape, 0.25)
