...
class Model():
    ...
    def train(self):
        ...
        torch.nn.init.trunc_normal_(self.B, mean=0.0, std=3, a=-2, b=2)

        #self.B = torch.normal(0, 15, size=(128, self.dim))
        ...
        for epoch in range(1, self.Params['Training']['Number of Epochs']+1):
            ...
            alpha = min(1.0, 0.3 + epoch / 2000.0)
            ...
            while True:
                ...
                if (diff_ratio < 1.5 and diff_ratio > 0):
