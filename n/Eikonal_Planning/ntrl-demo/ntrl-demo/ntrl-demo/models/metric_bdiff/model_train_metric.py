...
from models.metric_bdiff import model_network_metric as model_network
#from models import model_network_lowrank as model_network

#from models import model_network_fixgoal as model_network

from models.metric_bdiff import model_function_metric as model_function
...
class Model():
    ...
    def train(self):
        ...
        source_folder = './models/metric_bdiff'
        ...
        #self._init_network()
        # B init: metric_arm's scheme (models/metric_arm/model_train_metric.py).
        # metric draws trunc_normal_(std=2, a=-2, b=2) -> realized sigma ~1.08;
        # this is a plain scaled Gaussian with sigma exactly 0.2, i.e. a much
        # narrower Fourier bandwidth and effectively no high-frequency terms.
        ...
        self.function = model_function.Function(self.folder, self.Params['Device'],self.network,self.dim,self.Params['DataPath'])
