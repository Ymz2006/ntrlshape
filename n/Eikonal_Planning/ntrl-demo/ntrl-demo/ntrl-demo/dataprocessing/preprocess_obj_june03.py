"""FROZEN COPY of dataprocessing/preprocess_obj.py at commit d979b1c (2026-06-03,
"baseline finished") -- the generator that produced the data behind
pretrained/baseline_rectangle_env1.pt (checkpoint written 2026-06-03 23:18,
committed 23:26 as ce6b5cd).
...
Era defaults that differ from the current generator:
    ...
    --batch_size 256 (now 3000)
    DEFAULT_ENV_POINTS 8000 (now 10000)

The README at that commit documents the training set as:
    python dataprocessing/preprocess_obj.py \
        ...
        --num_samples 400000 \
        --visualize
(now 800000 samples with --batch_size 2000).
"""
